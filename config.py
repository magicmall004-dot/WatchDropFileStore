...
APP_ID = int(os.environ.get("APP_ID", "21404189")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "bd7028cc6f1bad77cd8e53023bf895b6") #Your API Hash from my.telegram.org
#--------------------------------------------
...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Flame:HtunHlaAung-007047@watch-drop.cmn22zb.mongodb.net/?retryWrites=true&w=majority&appName=WATCH-DROP")
DB_NAME = os.environ.get("DATABASE_NAME", "Zaws-File-Share")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "-1002585566095"))  # 0 means no expiry
